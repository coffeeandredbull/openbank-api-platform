...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleApiNotFound(ApiNotFoundException ex, HttpServletRequest request) {
        return build(HttpStatus.NOT_FOUND, "API_NOT_FOUND", ex.getMessage(), request, Map.of());
    }

    @ExceptionHandler(ContextPathAlreadyExistsException.class)
    public ResponseEntity<ErrorResponse> handleContextPathAlreadyExists(ContextPathAlreadyExistsException ex, HttpServletRequest request) {
    ...
    public ResponseEntity<ErrorResponse> handleInvalidSubscriptionStatusTransition(InvalidSubscriptionStatusTransitionException ex, HttpServletRequest request) {
    ...
    @ExceptionHandler(SubscriptionTierInUseException.class)
    public ResponseEntity<ErrorResponse> handleSubscriptionTierInUse(SubscriptionTierInUseException ex, HttpServletRequest request) {
        return build(HttpStatus.CONFLICT, "SUBSCRIPTION_TIER_IN_USE", ex.getMessage(), request, Map.of());
    }
