...
class AccountSecurityIntegrationTest {
    ...
    @Test
    void developerCanCreateListAndGetOwnAccount() throws Exception {
    ...
    @Test
    void adminCanCreateListAndGetOwnAccount() throws Exception {
    ...
    @Test
    void developerCannotGetAnotherDevelopersAccount() throws Exception {
        Long accountId = createAccountAndReadId("42", "DEVELOPER");
    ...
    @Test
    void adminCannotGetAnotherDevelopersAccount() throws Exception {
        Long accountId = createAccountAndReadId("42", "DEVELOPER");
        ...
        mockMvc.perform(get("/accounts/" + accountId)
                ...
                .andExpect(r -> {
                    ...
                    assertThat(body).doesNotContain("currency");
                });
    }

    @Test
    void adminListDoesNotReturnAnotherUsersAccount() throws Exception {
        createAccountAndReadId("42", "DEVELOPER");
    ...
    @Test
    void developerCannotCreateSecondAccountOnceOneExists() throws Exception {
        createAccountAndReadId("42", "DEVELOPER");
