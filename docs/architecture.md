...
- **Tier lifecycle / tier administration**: the ADMIN-only partial update
  `PATCH /subscription-tiers/{tierId}` is implemented (Phase 24 Slice 8);
  creation/listing/deletion, lifecycle, and pricing/hard limits remain planned.
